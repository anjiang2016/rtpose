...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='imresize_param', full_name='caffe.LayerParameter.imresize_param', index=58,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='nms_param', full_name='caffe.LayerParameter.nms_param', index=59,
...
_TRANSFORMATIONPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='stride', full_name='caffe.TransformationParameter.stride', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scale_cvg', full_name='caffe.TransformationParameter.scale_cvg', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_cvg_len', full_name='caffe.TransformationParameter.max_cvg_len', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_cvg_len', full_name='caffe.TransformationParameter.min_cvg_len', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='opaque_coverage', full_name='caffe.TransformationParameter.opaque_coverage', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='coverage', full_name='caffe.TransformationParameter.coverage', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='flip_prob', full_name='caffe.TransformationParameter.flip_prob', index=13,
      number=12, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0.5),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='max_rotate_degree', full_name='caffe.TransformationParameter.max_rotate_degree', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='visualize', full_name='caffe.TransformationParameter.visualize', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='crop_size_x', full_name='caffe.TransformationParameter.crop_size_x', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='crop_size_y', full_name='caffe.TransformationParameter.crop_size_y', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scale_prob', full_name='caffe.TransformationParameter.scale_prob', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scale_min', full_name='caffe.TransformationParameter.scale_min', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scale_max', full_name='caffe.TransformationParameter.scale_max', index=20,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bbox_norm_factor', full_name='caffe.TransformationParameter.bbox_norm_factor', index=21,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='img_header', full_name='caffe.TransformationParameter.img_header', index=22,
...
_NMSPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_peak', full_name='caffe.NmsParameter.num_peak', index=1,
      number=2, type=13, cpp_type=3, label=1,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_parts', full_name='caffe.NmsParameter.num_parts', index=3,
      number=4, type=13, cpp_type=3, label=1,
...
_IMRESIZEPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='factor', full_name='caffe.ImResizeParameter.factor', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='start_scale', full_name='caffe.ImResizeParameter.start_scale', index=3,
      number=4, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='scale_gap', full_name='caffe.ImResizeParameter.scale_gap', index=4,
      number=5, type=2, cpp_type=6, label=1,
